...
for cluster in range(num_clusters):
    ...
    if len(indices) > 0:
        ...
        #ax2.scatter(tsne_results[best_combination, 0], tsne_results[best_combination, 1], s=300,color='black', alpha=0.5)
plt.show()
...
for cluster in range(num_clusters):
    ...
    if len(indices) > 0:
     ...
     #  ax3.scatter(tsne_3d_results[best_combination, 0], tsne_3d_results[best_combination, 1],
     #               tsne_3d_results[best_combination, 2], s=600, color='black', alpha=1)
